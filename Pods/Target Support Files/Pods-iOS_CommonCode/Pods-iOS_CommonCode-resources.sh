...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaAdSupport/AppMetricaAdSupport.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaCore/AppMetricaCore.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaCoreExtension/AppMetricaCoreExtension.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaCoreUtils/AppMetricaCoreUtils.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaCrashes/AppMetricaCrashes.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaEncodingUtils/AppMetricaEncodingUtils.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaFMDB/AppMetricaFMDB.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaHostState/AppMetricaHostState.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaLog/AppMetricaLog.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaNetwork/AppMetricaNetwork.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaPlatform/AppMetricaPlatform.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaProtobuf/AppMetricaProtobuf.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaProtobufUtils/AppMetricaProtobufUtils.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaStorageUtils/AppMetricaStorageUtils.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppMetricaWebKit/AppMetricaWebKit.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/KSCrash/KSCrashPrivacy.bundle"
