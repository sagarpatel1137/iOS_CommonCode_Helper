...
class SubAllPlanVC: UIViewController {
    ...
    //MARK: -
    var arrFeature: [FeatureModel] = [
        FeatureModel(featureName: "AI Voices", imgName: "ic_sub_all_aivoice"),
        FeatureModel(featureName: "Sync Voices", imgName: "ic_sub_all_sync"),
        FeatureModel(featureName: "Voice Controls", imgName: "ic_sub_all_voicecontrols"),
        FeatureModel(featureName: "Pranks Sounds", imgName: "ic_sub_all_pranksound"),
        FeatureModel(featureName: "Funny Reels", imgName: "ic_sub_all_funnyreels"),
        FeatureModel(featureName: "Ads Free", imgName: "ic_sub_all_ads")
    ]
    var arrFeatureLoop: [FeatureModel] = []
...
extension SubAllPlanVC
{
    ...
    private func purchaseSuccess()
    {
        ...
        if selected_Plan.plan_Type == SubscriptionConst.SubscriptionType.week {
            if RevenueCat_Manager.shared.isWeekIntroductoryAvailable {
            ...
            if RevenueCat_Manager.shared.isOneMonthIntroductoryAvailable {
            ...
            if RevenueCat_Manager.shared.isYearIntroductoryAvailable {
        ...
        self.dismiss(animated: true, completion: {
            self.completionMorePlan!("success")
        })
    }
...
extension SubAllPlanVC : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView.tag == 100
        {
            ...
            cell.imgThumb.image = UIImage(named: arrFeatureLoop[indexPath.item].imgName)
            cell.lblName.text = arrFeatureLoop[indexPath.item].featureName.localized()
